      ...
      <el-col :xs="24" :sm="24" :md="12" :lg="8">
        <el-card class="update-log">
          ...
          <el-collapse accordion>
            <el-collapse-item title="v2.0.0-rc1 - 2026-04-17">
              <ol>
                <li>完成 MyEMS-PV 向 RuoYi-Vue3 的全栈迁移，默认首页切换为监控大屏</li>
                <li>补齐 MQTT 动态订阅、Dashboard WebSocket 推送与告警分发链路</li>
                <li>新增前后端测试基线，当前后端 91/91、前端 26/26 全绿</li>
                <li>完成 Docker Compose UAT 实跑、冒烟脚本与发布候选物料整理</li>
              </ol>
            </el-collapse-item>
